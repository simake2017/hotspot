...
/*
 * wangyang
 * klass, name, signature, may_be_java
 * 注入的是  java/lang/invoke/MemberName 类 vmtarget字段
 */
...
/*
 * wangyang
 * 这里是对特定 的类 的特定字段进行注入，需要注意的是 这里是 jdk1.6， 所以需要去看1.6的源码
 * 1.7以上 的 对应的代码是 不同的，不是这种注入方式
 */
